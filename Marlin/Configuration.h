...
#define STRING_CONFIG_H_AUTHOR "(nemphys, Anycubic I3 Mega)" // Who made the changes.
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 237 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 6, 70 }
...
#define Z_PROBE_FEEDRATE_FAST (10*60 * 3)
...
#define Z_AFTER_HOMING  -1.5      // (mm) Height to move to after homing Z
...
// Servo parts fan configuration by Nemphys

#define FAN0_IS_SERVO
#define FAN0_SERVO_NO 0
#define FAN0_SERVO_MIN 1000
#define FAN0_SERVO_MAX 1900

// Extruder LED pin configuration by Nemphys

#define EXTRUDER_LED_PIN 12
#define STAT_LED_RED_PIN EXTRUDER_LED_PIN
